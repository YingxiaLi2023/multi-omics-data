...
# and replace 'pathtomulti-omics-data' by the path to 'multi-omics-data-mian'
# on your computer):
...
comb <- c( "rna","mirna","methy","mutation","cnv",
...
save(scenariogrid, file="./Features_1000/Results/Results_1_4_5_1000/rda_files/scenariogrid1.Rda") 

#### 5
# Source the functions that are used in performing the calculations 
# on the cluster:

source("./Features_1000/Functions/Functions_AnalysisCluster_1_4_5_1000.R")
