...
save(scenariogrid, file="./Features_1000/Results/Results_3_1000/rda_files/scenariogrid3.Rda") 

#### 5
# Source the functions that are used in performing the calculations 
# on the cluster:

source("./Features_1000/Functions/Functions_AnalysisCluster_3_1000.R.R")
